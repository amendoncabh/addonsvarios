...
class ProductsSalesReport(models.TransientModel):
    _name = 'products.sales.report.wizard'
    _description = "products Sales Report"
    ...
    def action_print_report(self, data):
        records = []
        report_name = "products.sales.report.jasper"
        wizard = self
        ...
        report = self.env.ref('ofm_so_ext.products_sales_report_jasper')
        report.write({
