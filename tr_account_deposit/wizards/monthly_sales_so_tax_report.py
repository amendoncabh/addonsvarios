...
class MonthlySalesTaxReport(models.TransientModel):
    _name = 'monthly.sales.so.tax.report.wizard'
    _description = "Monthly Sales Tax Report"
    ...
    def action_print_report(self, data):
        records = []
        report_name = "monthly.sales.so.tax.report.jasper"
        wizard = self
        ...
        monthly_sales_report = self.env.ref('tr_account_deposit.monthly_sales_so_tax_report_jasper')
