...
class DepositReturnSalesReport(models.TransientModel):
    _name = 'deposit.return.sales.report.wizard'
    _description = "Deposit Return Sales Report"
    ...
    def action_print_report(self, data):
        records = []
        report_name = "deposit.return.sales.report.jasper"
        wizard = self
        ...
        report = self.env.ref('ofm_so_ext.deposit_return_sales_report_jasper')
        report.write({
