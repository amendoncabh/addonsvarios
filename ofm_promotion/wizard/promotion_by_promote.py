...
class PromotionByPromoteReport(models.TransientModel):
    _name = 'promotion.by.promote.report.wizard'
    _description = "Promotion by Promote Report"
    ...
    def action_print_report(self, data):
        records = []
        report_name = "promotion.by.promote.report.jasper"
        wizard = self
        ...
        promotion_by_promote_name = self.env.ref('ofm_promotion.promotion_by_promote_report_jasper')

        promotion_by_promote_name.write({
