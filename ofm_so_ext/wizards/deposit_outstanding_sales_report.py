...
class DepositOutstandingSalesReport(models.TransientModel):
    _name = 'deposit.outstanding.sales.report.wizard'
    _description = "Deposit Outstanding Sales Report"
    ...
    def action_print_report(self, data):
        records = []
        report_name = "deposit.outstanding.sales.report.jasper"
        wizard = self
        ...
        report = self.env.ref('ofm_so_ext.deposit_outstanding_sales_report_jasper')
        report.write({
