...
class MonthlySalesTaxReport(models.TransientModel):
    _name = 'monthly.sales.tax.report.wizard'
    ...
    def action_print_report(self, data):
        records = []
        report_name = "monthly.sales.tax.report.jasper"
        wizard = self
        ...
        monthly_sales_report = self.env.ref('ofm_point_of_sale_ext.monthly_sales_tax_report_jasper')
