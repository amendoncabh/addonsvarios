...
class SummaryReceivedProductReturnReport(models.TransientModel):
    _name = 'summary.received.product.return.wizard'
    _description = "Summary Received Product Return Report"
    ...
    def action_print_report(self, data):
        ...
        if wizard.jasper_output == 'xls':
            report_name = "summary.received.product.return.report.jasper.excel"
        else:
            report_name = "summary.received.product.return.report.jasper.pdf"
