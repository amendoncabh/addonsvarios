...
class SalesReturnTaxReport(models.TransientModel):
    _name = 'sales.so.return.tax.report.wizard'
    _description = "Sales So Return Tax Report"
    ...
    def action_print_report(self, data):
        records = []
        report_name = "sales.so.return.tax.report.jasper"
        wizard = self
        ...
        monthly_sales_report = self.env.ref('tr_account_deposit.sales_so_return_tax_report_jasper')
