...
class SalesTaxReturnReport(models.TransientModel):
    _name = 'sales.tax.return.report.wizard'
    _description = "Sales Tax Return Report"
    ...
    def action_print_report(self, data):
        records = []
        report_name = "sales.tax.return.report.jasper"
        wizard = self
        ...
        sales_report = self.env.ref('ofm_point_of_sale_ext.sales_tax_return_report_jasper')
        sales_report.write({
